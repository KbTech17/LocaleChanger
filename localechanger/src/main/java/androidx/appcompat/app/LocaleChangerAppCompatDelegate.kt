...
import com.dp.localechanger.LocaleChanger

class LocaleChangerAppCompatDelegate(private val superDelegate: AppCompatDelegate) :
    AppCompatDelegate() {
    ...
    private fun wrap(context: Context): Context = LocaleChanger.onAttach(context)
}
